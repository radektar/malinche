...
def engine(tmp_path):
    ...
    _note(tmp_path, "jakosc", "Jakosc materialow", "18.06",
          "Budzet przekroczony dwukrotnie, rozwazasz obnizenie jakosci materialow naturalnych.")
    _note(tmp_path, "skala", "Strategia skalowania", "01.06",
...
def test_reindex_reflects_edits(engine, tmp_path):
    ...
    _note(tmp_path, "okna", "Notatka", "14.06", "Kalendarz spotkania rano, ustalenia dotyczace planu.")
